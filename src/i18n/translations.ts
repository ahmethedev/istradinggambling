export const resources = {
  en: {
    translation: {
      ...
      share: {
        ...
        title: "Share Your Trading Simulation",
        copyLink: "Copy Link",
        shareTwitter: "Share on Twitter",
        linkCopied: "Link copied to clipboard!",
        copyError: "Failed to copy link",
        twitterText: "Check out my trading simulation results on istradinggamble.com! 📈"
      },
      newsletter: {
        title: "Join Our Trading Newsletter",
        description: "Get weekly insights, tips, and analysis",
        placeholder: "Enter your email",
        submit: "Subscribe",
        success: "Thank you for subscribing!"
      },
      disclaimer: "Disclaimer: Trading involves substantial risk of loss. Past simulation results do not guarantee future performance.",
      nav: {
        home: "Home",
        about: "About",
        contact: "Contact"
  ...
  tr: {
    translation: {
      ...
      riskReward: "Risk/Kazanç Oranı",
      maxTrades: "Günlük Maksimum İşlem",
      ...
      metrics: {
        ...
        longestWinStreak: "En Uzun Kazanç Serisi",
        longestLossStreak: "En Uzun Kayıp Serisi",
        finalBalance: "Final Bakiye",
      ...
      share: {
        ...
        title: "Trading Simülasyonunuzu Paylaşın",
      ...
      newsletter: {
        ...
        description: "Haftalık içgörüler, ipuçları ve analizler alın",
        placeholder: "E-posta adresiniz",
        submit: "Abone Ol",
        success: "Abone olduğunuz için teşekkürler!"
      },
      disclaimer: "Yasal Uyarı: Trading önemli kayıp riski içerir. Geçmiş simülasyon sonuçları gelecekteki performansı garanti etmez.",
      nav: {
        home: "Ana Sayfa",
        about: "Hakkında",
        contact: "İletişim"
